...
\usepackage{listings}
  ...
  \lstset{
    ...
    keywords=[3]{else,tag,gamma,uniform_continuous,log,make_squaredexp,make_whitenoise,gpmem,mapv,first,repeat,do,mh,one,add_funcs,make_se,lambda,emulator,lookup,argmax_of_array,linspace,run,array,pass,mc_argmax,uniform_structure,subset,lte,if,flip,mult_funcs,for,to},
    basicstyle=\LSTfont,
    literate=%
